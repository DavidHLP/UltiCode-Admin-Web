...
const isLoading = ref<boolean>(false); // Use a local ref for loading state
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <form @submit.prevent="onSubmit" class="flex flex-col">
                        ...
                        <div class="mb-6 flex flex-col gap-2">
                            <InputText id="email1" type="text" placeholder="邮箱地址" class="w-full md:w-[30rem]" v-model="email" :invalid="!!errors.email" autocomplete="username" />
                        ...
                        <div class="mb-6 flex flex-col gap-2">
                            <Password id="password1" v-model="password" placeholder="密码" :toggleMask="true" class="mb-0" fluid :feedback="false" :invalid="!!errors.password" autocomplete="current-password"></Password>
                        ...
                        <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                            ...
                            <RouterLink to="/auth/forgot-password" class="font-medium no-underline ml-2 text-right cursor-pointer text-primary hover:underline"> 忘记密码? </RouterLink>
                        </div>
                        ...
                        <div class="text-center mt-6 text-sm text-muted-color">
                            <span>还没有账号？</span>
                            <RouterLink to="/auth/register" class="font-medium text-primary cursor-pointer no-underline hover:underline ml-1"> 立即注册 </RouterLink>
                        </div>
                    </form>
                </div>
            </div>
