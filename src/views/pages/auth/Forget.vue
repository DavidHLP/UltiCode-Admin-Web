        ...
        <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
          <div class="text-center mb-8 flex flex-col items-center gap-4">
            ...
            <span class="text-muted-color font-medium text-base max-w-[22rem]">
              输入您的注册邮箱，我们将通过邮件帮助您找回密码。
            </span>
          </div>

          <form @submit.prevent="onSubmit" class="flex flex-col">
            <label for="reset-email" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">
              邮箱
            </label>
            ...
            <Message v-if="successMessageVisible" severity="success" class="mb-6">
              如果邮箱存在，我们将在几分钟内发送邮件，请注意查收。
            </Message>
